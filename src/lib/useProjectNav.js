...
//   navigate('/')               → /:slug/board   (Sprint-Board = Projekt-Home-Board)
//   navigate(-1)                → History-Delta unverändert
//   navigate('/settings/ai-cost', { global: true }) → /settings/ai-cost (kein Slug)
...
// Top-Level-Routen ohne Projekt-Slug (D02/D05). Wird ein Pfad mit einem dieser
// Segmente begonnen, prefixt useProjectNav NICHT.
 ...
 * @param {object} [opts]  { global?: boolean }
