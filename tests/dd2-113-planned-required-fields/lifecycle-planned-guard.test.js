...
// Reopen-Pfade (completed/passed → planned) bleiben unberührt.
...
describe('DD2-113 — Reopen-Pfade bleiben unberührt', () => {
  test('completed → planned erlaubt ohne goal/background (Reopen)', () => {
    expect(canTransition('completed', 'planned', {}).allowed).toBe(true)
  })
