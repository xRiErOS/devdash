...
const ACTIVE = [
  { id: 104, key: 'DD2#49', name: 'Browser-Organismus + Bausteine', status: 'active', issue_done: 1, issue_total: 5, issue_cancelled: 3, issues: [
    { key: 'DD2-220', title: 'BrowserToolbar-Organismus', status: 'done' },
    { key: 'DD2-221', title: 'FilterMenu-Popover anbinden', status: 'active' },
  ] },
  { id: 105, key: 'DD2#50', name: 'Promote: _mockups → src/ui', status: 'planning', issue_done: 0, issue_total: 3, issues: [
    { key: 'DD2-230', title: 'ElementRow nach atoms ziehen', status: 'planning' },
  ] },
]
const COMPLETED = [
  { id: 103, key: 'DD2#40', name: 'Clean-Cut Baseline', status: 'done' },
