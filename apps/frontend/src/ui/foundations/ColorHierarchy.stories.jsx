/**
 * GF — 01 FOUNDATIONS / Color Hierarchy.
...
const meta = {
  title: '01 FOUNDATIONS/Color Hierarchy/Color Hierarchy',
    ...
    <div className="ch-shell" data-ui="fnd.hier.shell">
      ...
      <div className="ch-shell__body">
        <div className="ch-shell__rail">
          <div className="ch-rail__item ch-rail__item--active"><span className="ch-rail__caret">▸</span><span className="ch-rail__idx">[gi]</span>Issues</div>
          <div className="ch-rail__item"><span className="ch-rail__idx">[gs]</span>Sprints</div>
          <div className="ch-rail__item"><span className="ch-rail__idx">[gr]</span>Roadmap</div>
        </div>
