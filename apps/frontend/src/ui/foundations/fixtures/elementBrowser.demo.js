...
export const FLAT_ISSUES = [
  ...
  { id: 'i7', kind: 'issue', issueType: 'feature', entityId: 'DD2-13', title: 'BulkActionBar Slide-out beim Leeren der Selektion', status: 'completed', priority: 3 },
...
export const NESTED_TREE = [
  {
    id: 'm1', kind: 'milestone', entityId: 'M3', title: 'ElementBrowser-Reihe ausliefern', status: 'in_progress', priority: 1,
    children: [
      {
        id: 's1', kind: 'sprint', entityId: 'DD#49', title: 'Browser-Organismus + Bausteine', status: 'in_progress', priority: 2,
        children: [
          { id: 'i1', kind: 'issue', issueType: 'feature', entityId: 'DD2-7', title: 'Project-Switcher im Header verdrahten', status: 'in_progress', priority: 1 },
          { id: 'i2', kind: 'issue', issueType: 'bug', entityId: 'DD2-8', title: 'Capture-Host-Guard 403 bei OPTIONS', status: 'to_review', priority: 1 },
        ],
      ...
      {
        id: 's2', kind: 'sprint', entityId: 'DD#50', title: 'Promote: _mockups → src/ui', status: 'new', priority: 3,
        children: [
  ...
  {
    id: 'm2', kind: 'milestone', entityId: 'M4', title: 'Backlog- & SprintReview-Screen', status: 'new', priority: 2,
    children: [
      {
        id: 's3', kind: 'sprint', entityId: 'DD#51', title: 'Connected-Wrapper + Daten-Layer', status: 'new', priority: 2,
        children: [
