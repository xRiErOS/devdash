...
const meta = {
  title: '01 FOUNDATIONS/Motion/Motion',
  ...
  render: () => (
    <div className="flex flex-col gap-2" data-ui="fnd.motion.interaction">
      ...
      <div className="flex gap-2">
        <button className="motion-demo-btn" data-ui="fnd.motion.press">Press / Tab</button>
        <button className="motion-demo-btn motion-demo-btn--danger" data-ui="fnd.motion.press-danger">Danger</button>
      </div>
    </div>
  ),
}
